...
<div class="flex min-h-screen">
    <aside class="w-64 bg-slate-900 text-slate-300 shrink-0 shadow-xl">
        ...
        <nav class="mt-4 px-4 space-y-1">
            <a href="{{ route('admin.dashboard.index') }}" class="flex items-center gap-3 py-3 px-4 rounded-lg hover:bg-red-600 hover:text-white transition-all duration-200 group">
